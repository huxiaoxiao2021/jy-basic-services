...
public class JyThirdpartyUser {
    ...
    public String getTaskDetailBizId() {
        return taskDetailBizId;
    }

    public void setTaskDetailBizId(String taskDetailBizId) {
        this.taskDetailBizId = taskDetailBizId;
    }
    ...
    public String getUserCodeIndex() {
        return userCodeIndex;
    }

    public void setUserCodeIndex(String userCodeIndex) {
        this.userCodeIndex = userCodeIndex;
    }

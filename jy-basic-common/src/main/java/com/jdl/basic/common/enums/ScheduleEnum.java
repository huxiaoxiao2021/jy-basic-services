...
public enum ScheduleEnum {
    ...
    private static HashMap<Integer, String> codeToNameMap = new HashMap<Integer, String>();
    private static HashMap<String, Integer> nameToCodeMap = new HashMap<String, Integer>();

...
public class CacheServiceImpl implements CacheService {
    ...
    private static Cache<String, Byte> hasSetExpireTimeKeySet
            ...
            .build();
	public CacheServiceImpl(Cluster jimdbClient) {
		super();
	...
	public CacheServiceImpl(Cluster jimdbClient, long exTime, TimeUnit exTimeUnit) {
		super();
		this.exTime = exTime;
	...
	private <T> T deserialize(String in,Class<T> responseType) {
		...
		try {
			return JsonHelper.toObject(in, responseType);
		} catch (Exception e) {

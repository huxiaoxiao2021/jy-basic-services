...
public interface CacheService {
	 ...
	 * @return
	 */
	<T> T hGet(String key, String keyField,Class<T> responseType);
	/**
	 * 从缓存中获取hash结构中的所有对象
	 * @param key
	 * @return
	 ...
	 * @return
	 */
	<T> Map<String,T> hGetAll(String key,Class<T> responseType);
	/**
	 * 从hash结构中删除一个值
	 * @param key
	 * @param keyField
	 ...
	 * @return
	 */
	<T> Set<T> sMembers(String key,Class<T> responseType);
	/**
	 * 删除某个key
	 * @param key
	 * @return
